...
<h2 style="color: darkblue;font size=12"> Climate Monitoring Brief: STT and STJ</h2>
--------
...
* The NCRMP Atlantic climate monitoring team recently traveled to XX from XX to XX, 2023
* XX different sites were visited by three team members and collaborators completing a total of XX dives. 
...
```{r CAUs, echo=FALSE, out.width = '50%', fig.cap="Figure 5: CAU and BMU pair before retreval after being deployed for three years. CAUs are two parallel PVC plates to quantify settled accretors. BMU is mounted coral skeleton installed at the base of the metal stake and has been encrusted.", fig.align='center'}
